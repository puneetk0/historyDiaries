...
>(
  (
    ...
    const [carouselRef, api] = useEmblaCarousel(
      {
        ...
        dragFree: false, // Ensure snap alignment
        containScroll: "trimSnaps", // Keep slides contained
    ...
    React.useEffect(() => {
      ...
      // This function ensures that after dragging, the carousel snaps to the closest slide
      const handleDragEnd = () => {
      ...
      if (typeof api.on === 'function') {
        api.on("select", handleDragEnd)
      }
      
      return () => {
        if (api && typeof api.off === 'function') {
          api.off("select", handleDragEnd)
        }
      }
    }, [api])
